...
func TestGrpc_DoGrpc(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := g.DoGrpc(tt.args.req, tt.args.token)
...
func TestGrpc_getSlvSvcClient(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := g.getSlvSvcClient(tt.args.ep, tt.args.insecure, tt.args.loc, tt.args.token)
			if (err != nil) != tt.wantErr {
...
func TestGrpc_connect(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := g.connect(tt.args.ep, tt.args.insecure, tt.args.loc, tt.args.token)
			if (err != nil) != tt.wantErr {
